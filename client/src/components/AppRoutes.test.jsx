...
jest.mock("../features/posts/EditPostForm", () => {
  const MockEditPostForm = () => (
    <div>Here is the matched post edit form component</div>
  );
...
describe("AppRoutes component", () => {
  ...
  test("/posts/:id/edit path renders Edit Post Form", () => {
    renderWithRouter(<AppRoutes />, { initialEntries: ["/posts/1/edit"] });
    const expectedtext = "Here is the matched post edit form component";
    expect(screen.getByText(expectedtext)).toBeInTheDocument();
  });
});
